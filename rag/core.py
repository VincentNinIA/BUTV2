...
def answer(question: str, product_id: str = None, required_qty: int = 0, 
    ...
    """
    try:
        # Utiliser la version optimisée pour de meilleures performances (12.7x plus rapide)
        from .retrieval_optimized import fetch_docs_optimized
        result = fetch_docs_optimized(question, product_id=product_id, required_qty=required_qty, prix_propose=prix_propose)
    except ValueError:
